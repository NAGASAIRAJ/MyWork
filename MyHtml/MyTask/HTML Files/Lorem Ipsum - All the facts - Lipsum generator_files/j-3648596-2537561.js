...
(function(){
    ...
    (function() {
    var p = "3648596", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3648596||'',
    guid:window.ftGUID_3648596||'',
    confID:window.ftConfID_3648596||'0',
    ftReturn: window.ftReturn_3648596||'',
    keyword:window.ftKeyword_3648596||'',
    ftId:window.ftId_3648596||'',
    ftImpId:window.ftImp3648596 && window.ftImp3648596.impID || '',
    campaignID: '104199',
    cID:'100966',
    pID:'3648596',
    creativeID:'2537561',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104199&sid=653&plc=3648596&num=&adid=&advid=&adsrv=29&btreg=3648596&btadsrv=flashtalking&crt=2537561&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/104199;3648596;2537561;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?131843942-3648596;2537561;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/364/3648596/2537561/image/2537561.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/104199;3648596;202;pixel;DBM;DBMFY19CCPSPInMarketINPPWB728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/104199;3648596;2537561;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display',
    divID:'ftdiv3648596',
    altimgID:'ftalt3648596',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3648596 && parseInt(window.ftImp3648596.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3648596') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3648596'),
    pageVisible: 'maybe',
...
//TA_1 min
//ftMinified
(function(b){var c=window["ftImp"+b.pID]&&window["ftImp"+b.pID].privacy;c&&"x"!==c||((new Image).src=b.replaceMacros("ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2035&ta_partner_did=[GUID]&ta_format=png",!0),"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]),window.ftD9ResponseRegister.push({getD9Id:function(){return window.ft_d9ID||""},d9Response:function(b){var a="";try{a=b.DeviceID[0]}catch(d){}"timeout"!=a&&a?this.getD9Id()||(window.ft_d9ID=a||"",this.getD9Id()&&(this.d9Response=function(){})):a="";a&&((new Image).src="ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2176&ta_partner_did="+a+"&ta_format=png")}}))}(ft3648596));
